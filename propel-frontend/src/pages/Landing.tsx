        ...
        {[
          {
            ...
            desc: 'Competitors, audience, and positioning — instantly.',
          },
          {
            icon: <Cpu size={22} />,
            title: 'Tech Recommendations',
            desc: 'The right stack for your scale, chosen by AI.',
          },
          {
            icon: <BarChart3 size={22} />,
            title: 'Visual Insights',
            desc: 'Interactive charts that turn data into clarity.',
          },
        ].map((f) => (
